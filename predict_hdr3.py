...
print('~~~loading data~~~')
##Import data
ampstats = np.load('amp_stats_hdr3_20220204.npy', allow_pickle=True)
...
#print_confusion_matrix(flag_df['cut_flag'].to_numpy().astype('int'),
#			np.argmax(pred_cut_labels,axis=1), 'Cut')
...
np.save('saved_predictions/predictions_hdr3.npy', savstr)
